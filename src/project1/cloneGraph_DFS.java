...
public class cloneGraph_DFS {
	...
	static Node createClone(Node node) {
		...
		if (!cloneMap.containsKey(node)) {
			...
			for (Node n : node.neighbours) {
				clone.neighbours.add(createClone(n));
			}
		}
	...
	public static void main(String[] args) {
		...
		Node n2 = new Node(2);
		Node n3 = new Node(3);
		n0.neighbours.addAll(Arrays.asList(n1, n2));
		n1.neighbours.addAll(Arrays.asList(n0, n2));
		n2.neighbours.addAll(Arrays.asList(n0, n1, n3));
